...
public class Producto implements Serializable {
	...
	public Valorproductocuantitativo removeValorproductocuantitativo(
			Valorproductocuantitativo valorproductocuantitativo) {
	...
	public String toString(){
		return "Categoria:"+ categoria.toString()+"ID:"+idproducto+"Color:"+color; 
