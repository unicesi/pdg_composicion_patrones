...
@NamedQueries({
		...
		@NamedQuery(name = "Valorproductocuantitativo.findById", query = "SELECT v FROM Valorproductocuantitativo v WHERE v.idvalorcuantitativo = :idValorCuantitativo"),
		@NamedQuery(name = "Valorproductocuantitativo.findByIdAndByIdProducto", query = "SELECT v FROM Valorproductocuantitativo v WHERE v.idvalorcuantitativo = :idValorCuantitativo AND v.producto = :idProducto") })
