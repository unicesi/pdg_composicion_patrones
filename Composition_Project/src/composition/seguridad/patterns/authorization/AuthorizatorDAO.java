...
import composition.tienda.entities.Authorizationinformation;
import composition.tienda.entities.AuthorizationinformationPK;
...
public class AuthorizatorDAO {
	...
	public Collection<Authorizationinformation> findAll() {
		Collection<Authorizationinformation> authorizationinformations = entityManager
				.createNamedQuery("Authorizationinformation.findAll").getResultList();
		return authorizationinformations;
	}
