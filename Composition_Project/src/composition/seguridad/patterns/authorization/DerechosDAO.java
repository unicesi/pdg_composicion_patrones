...
import composition.tienda.entities.Derecho;
import composition.tienda.entities.DerechoPK;
...
public class DerechosDAO {
	...
	public Derecho findByNameProtectedObject(String nameProtectedObject) {
		Derecho derecho = (Derecho) entityManager.createNamedQuery("Derecho.findByNameProtectedObject")
				.setParameter("nameProtectedObject", String.valueOf(nameProtectedObject)).getResultList().iterator()
				.next();
		return derecho;
	}
