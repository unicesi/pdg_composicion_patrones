...
@Embeddable
@NamedQueries({
		@NamedQuery(name = "Authorizationinformation.findById", query = "SELECT a FROM Authorizationinformation a WHERE a.cod_subject = :codSubject AND d.id_system = :idSystem"),
